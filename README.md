...
- 3 - Agora iremos navegar até a pasta do projeto [cd /usr/share/nginx] e aguarde...
- 3 - Agora iremos instalar as bibliotecas(composer) [composer install] e aguarde...
- 3 - Agora iremos criar novas tabelas para Banco Dados [php artisan migrate] e aguarde...
- 3 - Agora iremos gerar uma nova key [php artisan key:generate] e aguarde...
- 4 - Agora iremos criar uma nova aba navegador favorito.. [http://localhost:8080]
;
- 5 - Prontinho!
